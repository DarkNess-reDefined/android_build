...
""" % bcb_dev)
  ...
  if GetBuildProp("ro.dnd.display.version", OPTIONS.info_dict) is not None:
    buildid = GetBuildProp("ro.dnd.display.version", OPTIONS.info_dict)
    ...
    device = GetBuildProp("ro.dnd.device", OPTIONS.info_dict)
